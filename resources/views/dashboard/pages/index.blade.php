                    ...
                    <tr>
                        ...
                        <td class="pr-6">
                            <div x-data="{show: false}"
                                ...
                                <button @click="show = (show) ? false : true"
                                        type="button"
                                ...
                                <div
                                    ...
                                    <div class="py-1" role="none">
                                        ...
                                        <a href="{{ route('pages.edit', $page) }}" class="text-gray-700 group flex items-center px-4 py-2 text-sm"
                                    ...
                                    <div class="py-1" role="none">
                                        <form method="POST" action="{{ route('pages.destroy', $page) }}">
                                            @method('delete')
                                            @csrf
                                            <a href="{{ route('pages.destroy', $page) }}" class="text-gray-700 group flex items-center px-4 py-2 text-sm"
