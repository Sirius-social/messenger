...
{{--    <form action="{{ route('links.update', $link) }}" method="post" class="divide-y divide-gray-200 lg:col-span-9">--}}
{{--    @method('put')--}}
{{--    @csrf--}}
{{--    <!-- Session Status -->--}}
{{--        <x-session-status/>--}}
...
{{--                             required/>--}}
{{--                </div>--}}
{{--                <div x-data="{show: false, selectedName: '{{ array_flip($colors)[$link->color] }}', selectedClass: '{{ $link->color }}'}">--}}
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div x-data="{show: false, selectedName: '{{ $link->icon ? array_flip($icons)[$link->icon] : '' }}', selectedURL: '{{ $link->icon }}'}">--}}
{{--                    <label id="listbox-label" class="block text-sm font-medium text-gray-700">--}}
{{--                        {{ __('Choose link icon') }}--}}
{{--                    </label>--}}
{{--                    <div class="mt-1 relative">--}}
